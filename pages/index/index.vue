    ...
    <view class="tabbar">
      ...
      <view class="action" @tap.stop="changeTabbar(0)">
        <view class="bar-icon">
          ...
          <image class="" :src="`/static/tabbar/tn-tabbar0${currentTabbarIndex === 0 ? '-cur' : ''}.png`"></image>
        </view>
      ...
      <view class="action" @tap.stop="changeTabbar(1)">
        <view class="bar-icon">
          ...
          <image class="" :src="`/static/tabbar/tn-tabbar1${currentTabbarIndex === 1 ? '-cur' : ''}.png`"></image>
        </view>
      ...
      <view class="action" @tap.stop="changeTabbar(3)">
        <view class="bar-icon">
          ...
          <image class="" :src="`/static/tabbar/tn-tabbar2${currentTabbarIndex === 3 ? '-cur' : ''}.png`"></image>
        </view>
      ...
      <view class="action" @tap.stop="changeTabbar(4)">
        <view class="bar-icon">
          ...
          <image class="" :src="`/static/tabbar/tn-tabbar3${currentTabbarIndex === 4 ? '-cur' : ''}.png`"></image>
        </view>
