<template>
    ...
    <view class="" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
      ...
      <view class="tn-cat-shadow tn-margin tn-padding">
        <view class="tn-flex tn-flex-col-top">
          ...
          <view class="">
            <view class="logo-pic tn-shadow">
              <view class="logo-image">
                <view class="tn-shadow-blur" style="background-image:url('https://cdn.nlark.com/yuque/0/2022/png/280373/1666765211176-assets/web-upload/fafd21e9-b5e5-4243-8060-a3c3d3a570cf.png');width: 100rpx;height: 100rpx;background-size: cover;">
                </view>
              </view>
            </view>
          </view>
          <view class="tn-padding-left-sm" style="width: 100%;">
            ...
            <view class=" tn-padding-top-xs  tn-text-ellipsis-2">
              <text class="tn-color-gray">您的创作未通过审核，请修改后上传</text>
            </view>
      ...
      <view class="tn-margin tn-cat-shadow tn-padding" v-for="(item,index) in 28" :key="index" @click="tn('/messagePages/chat')">
