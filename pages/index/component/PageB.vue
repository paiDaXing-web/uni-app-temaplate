<template>
  <view class="page-b">
    ...
    <view class="tn-classify__wrap" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
      ...
      <!-- 搜索框 -->
      <view class="tn-classify__search--wrap" style="padding-bottom: 20rpx;" @click="tn('/homePages/search')">
        <view class="tn-color-gray--dark" style="margin: 20rpx 30rpx 0rpx 30rpx;border-radius: 100rpx;padding-left: 6rpx;background-color: rgba(248, 247, 248, 0.9);">
